...
CMessageParserDFM::CMessageParserDFM(void)
{
...
CParsedMessage CMessageParserDFM::ParseMessage( std::string _Message)
{
	/* DFM Parser Implementation */
	std::string stExchange = "DFM"; 	
	CParsedMessage _message;
	_message._Exchange = "DFM"; 
	try
	{
...
bool CMessageParserDFM::GetNextTagVal (std::string& msg, std::string& stTag, std::string& stVal, int & nMsgCounter, int & nMsgLen )
{
	stTag = "";
	stVal = "";
...
bool CMessageParserDFM::GetNextTagVal( char *& szMsg, std::string& stTag, std::string& stVal)
{
	stTag = "";
	stVal = "";
...
bool CMessageParserDFM::BestMarketData (std::string& stMessage)
{
	return TagExists ("139", stMessage); 
}

bool CMessageParserDFM::MarketByOrderData (std::string& stMessage)
{
	return (TagExists ("1100", stMessage) || TagExists ("1131", stMessage));
}
	
bool CMessageParserDFM::MarketByPriceData (std::string& stMessage)
{
	return (TagExists ("1250", stMessage) || TagExists ("1266", stMessage));
}

bool CMessageParserDFM::TagExists (std::string tag, std::string& msg)
{
...
bool CMessageParserDFM::TagExists_( char * szMsg, const std::string & stTag )
{
	int nChar  = 0;
	int nStart = 0;
	while( szMsg[ nChar ] != 0  )
...
bool CMessageParserDFM::BestMarketData( char * szMsg )
{
	return TagExists_( szMsg, "139" );
}

bool CMessageParserDFM::MarketByOrderData( char * szMsg )
{
	return TagExists_( szMsg, "1100" ) || TagExists_( szMsg, "1131" );
}
	
bool CMessageParserDFM::MarketByPriceData( char * szMsg )
{
	return TagExists_( szMsg, "1250" ) || TagExists_( szMsg, "1266" );
}
int CMessageParserDFM::FindTagValueIndex (std::string tag, std::string& msg)
{
	std::string str = "\n"+tag+"=";
